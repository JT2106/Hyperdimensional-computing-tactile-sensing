...
#
# Script generated by Vivado on Thu Jan 02 20:30:02 +0800 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : fix2float_input.sh
...
#
# Usage        : fix2float_input.sh
#                fix2float_input.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fix2float_input.sh [-reset_run]
#                fix2float_input.sh [-reset_log]
#                fix2float_input.sh [-help]
#
...
#                script (type 'fix2float_input.sh -help' for more information).
#
...
# script info
echo -e "fix2float_input.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fix2float_input.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fix2float_input xil_defaultlib.glbl -o fix2float_input_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fix2float_input_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fix2float_input_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fix2float_input_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fix2float_input.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fix2float_input.sh [-help]\n\
Usage: fix2float_input.sh [-step]\n\
Usage: fix2float_input.sh [-lib_map_path]\n\
Usage: fix2float_input.sh [-reset_run]\n\
Usage: fix2float_input.sh [-reset_log]\n\
Usage: fix2float_input.sh [-keep_index]\n\
Usage: fix2float_input.sh [-noclean_files]\n\n\
