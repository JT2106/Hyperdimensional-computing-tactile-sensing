...
#
# Script generated by Vivado on Thu Jan 02 20:31:19 +0800 2025
...
#
# Usage        : greater.sh
#                greater.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                greater.sh [-reset_run]
#                greater.sh [-reset_log]
#                greater.sh [-help]
#
...
#                script (type 'greater.sh -help' for more information).
#
...
# script info
echo -e "greater.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./greater.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.greater xil_defaultlib.glbl -o greater_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./greater_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key greater_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc greater_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./greater.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: greater.sh [-help]\n\
Usage: greater.sh [-step]\n\
Usage: greater.sh [-lib_map_path]\n\
Usage: greater.sh [-reset_run]\n\
Usage: greater.sh [-reset_log]\n\
Usage: greater.sh [-keep_index]\n\
Usage: greater.sh [-noclean_files]\n\n\
