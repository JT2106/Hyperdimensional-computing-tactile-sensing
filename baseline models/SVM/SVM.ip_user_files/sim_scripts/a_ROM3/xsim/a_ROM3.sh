...
#
# Script generated by Vivado on Wed Jan 08 16:35:55 +0800 2025
...
#
# Usage        : a_ROM3.sh
#                a_ROM3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                a_ROM3.sh [-reset_run]
#                a_ROM3.sh [-reset_log]
#                a_ROM3.sh [-help]
#
...
# script info
echo -e "a_ROM3.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./a_ROM3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot a_ROM3 xil_defaultlib.a_ROM3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim a_ROM3 -key {Behavioral:sim_1:Functional:a_ROM3} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb a_ROM3.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./a_ROM3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: a_ROM3.sh [-help]\n\
Usage: a_ROM3.sh [-step]\n\
Usage: a_ROM3.sh [-lib_map_path]\n\
Usage: a_ROM3.sh [-reset_run]\n\
Usage: a_ROM3.sh [-reset_log]\n\
Usage: a_ROM3.sh [-keep_index]\n\
Usage: a_ROM3.sh [-noclean_files]\n\n\
