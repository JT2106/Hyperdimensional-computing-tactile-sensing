...
#                script (type 'b_ROM0.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.b_ROM0 xil_defaultlib.glbl -o b_ROM0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./b_ROM0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key b_ROM0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc b_ROM0_simv.daidir vcs_lib c.obj)
