...
#                script (type 'SVs_ROM3.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.SVs_ROM3 xil_defaultlib.glbl -o SVs_ROM3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./SVs_ROM3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key SVs_ROM3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc SVs_ROM3_simv.daidir vcs_lib c.obj)
