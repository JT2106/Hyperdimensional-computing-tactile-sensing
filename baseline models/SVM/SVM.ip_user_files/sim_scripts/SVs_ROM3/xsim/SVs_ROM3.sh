...
#
# Script generated by Vivado on Wed Jan 08 16:40:36 +0800 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : SVs_ROM3.sh
...
#
# Usage        : SVs_ROM3.sh
#                SVs_ROM3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SVs_ROM3.sh [-reset_run]
#                SVs_ROM3.sh [-reset_log]
#                SVs_ROM3.sh [-help]
#
...
# script info
echo -e "SVs_ROM3.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SVs_ROM3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SVs_ROM3 xil_defaultlib.SVs_ROM3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SVs_ROM3 -key {Behavioral:sim_1:Functional:SVs_ROM3} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SVs_ROM3.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SVs_ROM3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SVs_ROM3.sh [-help]\n\
Usage: SVs_ROM3.sh [-step]\n\
Usage: SVs_ROM3.sh [-lib_map_path]\n\
Usage: SVs_ROM3.sh [-reset_run]\n\
Usage: SVs_ROM3.sh [-reset_log]\n\
Usage: SVs_ROM3.sh [-keep_index]\n\
Usage: SVs_ROM3.sh [-noclean_files]\n\n\
