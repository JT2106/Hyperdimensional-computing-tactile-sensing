...
#
# Script generated by Vivado on Thu Nov 28 22:25:48 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : activeAM_RAM.sh
...
#
# Usage        : activeAM_RAM.sh
#                activeAM_RAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                activeAM_RAM.sh [-reset_run]
#                activeAM_RAM.sh [-reset_log]
#                activeAM_RAM.sh [-help]
#
...
#                script (type 'activeAM_RAM.sh -help' for more information).
#
...
# script info
echo -e "activeAM_RAM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./activeAM_RAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.activeAM_RAM xil_defaultlib.glbl -o activeAM_RAM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./activeAM_RAM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key activeAM_RAM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc activeAM_RAM_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./activeAM_RAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: activeAM_RAM.sh [-help]\n\
Usage: activeAM_RAM.sh [-step]\n\
Usage: activeAM_RAM.sh [-lib_map_path]\n\
Usage: activeAM_RAM.sh [-reset_run]\n\
Usage: activeAM_RAM.sh [-reset_log]\n\
Usage: activeAM_RAM.sh [-keep_index]\n\
Usage: activeAM_RAM.sh [-noclean_files]\n\n\
