...
#
# Script generated by Vivado on Thu Nov 28 22:25:24 +0800 2024
...
#
# Usage        : AM_ROM.sh
#                AM_ROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AM_ROM.sh [-reset_run]
#                AM_ROM.sh [-reset_log]
#                AM_ROM.sh [-help]
#
...
# script info
echo -e "AM_ROM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AM_ROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot AM_ROM xil_defaultlib.AM_ROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim AM_ROM -key {Behavioral:sim_1:Functional:AM_ROM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb AM_ROM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./AM_ROM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: AM_ROM.sh [-help]\n\
Usage: AM_ROM.sh [-step]\n\
Usage: AM_ROM.sh [-lib_map_path]\n\
Usage: AM_ROM.sh [-reset_run]\n\
Usage: AM_ROM.sh [-reset_log]\n\
Usage: AM_ROM.sh [-keep_index]\n\
Usage: AM_ROM.sh [-noclean_files]\n\n\
