...
#                script (type 'CIM_ROM.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.CIM_ROM xil_defaultlib.glbl -o CIM_ROM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./CIM_ROM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key CIM_ROM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc CIM_ROM_simv.daidir vcs_lib c.obj)
